...
buckets_list = [
  {
    bucket_name = "dex-frontend-state-bucket"
  }
]
...
public_subnets = [
  "11.0.1.0/24", # us-east-1a - For NAT Gateway, Load Balancers
  "11.0.2.0/24", # us-east-1b - For NAT Gateway, Load Balancers
  "11.0.3.0/24"  # us-east-1c - For NAT Gateway, Load Balancers
]

private_subnets = [
  "11.0.11.0/24", # us-east-1a - For EKS nodes, application servers
  "11.0.12.0/24", # us-east-1b - For EKS nodes, application servers
  "11.0.13.0/24"  # us-east-1c - For EKS nodes, application servers
]

database_subnets = [
  "11.0.21.0/24", # us-east-1a - For RDS instances
  "11.0.22.0/24", # us-east-1b - For RDS instances
  "11.0.23.0/24"  # us-east-1c - For RDS instances
]

elasticache_subnets = [
  "11.0.31.0/24", # us-east-1a - For ElastiCache Redis
  "11.0.32.0/24", # us-east-1b - For ElastiCache Redis
  "11.0.33.0/24"  # us-east-1c - For ElastiCache Redis
]
