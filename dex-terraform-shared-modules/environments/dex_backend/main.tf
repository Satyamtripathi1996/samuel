...
module "external_ecr_permissions" {
  ...
  external_ecr_service_account = [
    ...
    "system:serviceaccount:dex-portal:dex-backend-external-ecr-image-pull",
    "system:serviceaccount:enrollment:dex-backend-external-ecr-image-pull",
    "system:serviceaccount:utility:dex-backend-external-ecr-image-pull",
    "system:serviceaccount:wep-admin:dex-backend-external-ecr-image-pull",
    "system:serviceaccount:wep-portal:dex-backend-external-ecr-image-pull"
  ]
}
...
module "secstore_permissions" {
  ...
  security_store_csi_service_account = [
    ...
    "system:serviceaccount:dex-portal:dex-backend-secrets-provider-aws",
    "system:serviceaccount:enrollment:dex-backend-secrets-provider-aws",
    "system:serviceaccount:utility:dex-backend-secrets-provider-aws",
    "system:serviceaccount:wep-admin:dex-backend-secrets-provider-aws",
    "system:serviceaccount:wep-portal:dex-backend-secrets-provider-aws"
  ]
}
...
module "route53" {
  ...
  zone = {
    "dex-be.mocafi.com" = {
      comment = "dex-be.mocafi.com (dex-backend)"
      name    = "dex-be.mocafi.com"
      # vpc = [
      #   {
      #     vpc_id     = module.network.vpc_id
